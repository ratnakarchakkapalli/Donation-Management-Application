...
import model.WorkQueue.DonorRegistrationWorkRequest;
...
public class RegistrationDonorJPanel extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        } else if (txtName.getText().length() <= 0 || (!ecosystem.checkIfUserIsUnique(txtName.getText()))) {
            JOptionPane.showMessageDialog(this, "User name already taken. Please input a new user name", "Warning", JOptionPane.WARNING_MESSAGE);
    ...
    private void sendEmail(String email, String name) {
        String to = email;
        String from = "wecarefundmngt@gmail.com";
        ...
        Session session = Session.getInstance(properties, new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("wecarefundmngt@gmail.com", "xefl wgyp mphy kcfe");
            }
